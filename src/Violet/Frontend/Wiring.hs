...
wiring icIssuer beCmd pushCap historyUpd = issuePorts
    where
        ...
        (pdCmd, pdAck, issuePorts, ghistory) = unbundle $ Violet.Frontend.ICache.icache icIssuer pcOut btbPrediction bhtPrediction pushCap
